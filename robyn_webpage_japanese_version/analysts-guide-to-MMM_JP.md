...
| ステップ | 説明 | タイミング |
| --------- | ----------- | -----------------   |
| ビジネス上の質問とスコープを定義する | 一般的な研究や分析と同様に、調査によって明らかにしたい主要なビジネス上の質問と目的を定義することが重要です。これにより、MMMの設計と実行方法が形作られ、MMMから最大の価値を得るのに役立ちます。この詳細は、[効果測定に関わるビジネス上の質問を収集する](#効果測定に関わるビジネス上の質問を収集する) セクションにあります。 | 1-2週間 |

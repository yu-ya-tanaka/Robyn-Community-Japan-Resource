...
| 分析とレコメンデーション | モデリングに満足したら、次のステップはアウトプットのデータと結果を分析し、元々のビジネス上の質問に基づいて実用的なレコメンデーションを行います。MMMからはさまざまな出力とメトリクスをアウトプットとして得られますが、詳細は、[モデルの応用](#モデルの応用)セクションです。 | 2-4週間 |
